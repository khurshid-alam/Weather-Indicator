...
class PreferencesWeatherIndicatorDialog(gtk.Dialog):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated PreferencesWeatherIndicatorDialog object.
        """
    ...
    def finish_initializing(self, builder):
        ...
        and creating a PreferencesWeatherIndicatorDialog object with it in order to
        finish initializing the start of the new PerferencesWeatherIndicatorDialog
        instance.
        ...
        self._db_name = "weather-indicator"
        ...
        self._record_type = (
            "http://wiki.ubuntu.com/Quickly/RecordTypes/WeatherIndicator/"
            "Preferences")
        self._preferences = self.get_preferences()
        # TODO: code for other initialization actions should be added here

    def get_preferences(self):
        """Return a dict of preferences for weather-indicator.
...
if __name__ == "__main__":
    dialog = PreferencesWeatherIndicatorDialog()
    dialog.show()
    gtk.main()
